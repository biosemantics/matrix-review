...
import edu.arizona.biosemantics.matrixreview.client.matrix.editing.Validator;
import edu.arizona.biosemantics.matrixreview.client.matrix.editing.TextFieldChangeHandler;
...
import edu.arizona.biosemantics.matrixreview.old.DataManager.StringValueProvider;
import edu.arizona.biosemantics.matrixreview.old.control.MyWindow;
import edu.arizona.biosemantics.matrixreview.old.control.SaveCategoriesEvent;
import edu.arizona.biosemantics.matrixreview.old.control.SaveCategoriesHandler;
...
public class ControlManager {
	...
	public void enableEditing(CharacterColumnConfig characterColumnConfig) {
		...
		case NUMERICAL:
			...
			Validator numericalsValidator = new Validator() {
				@Override
