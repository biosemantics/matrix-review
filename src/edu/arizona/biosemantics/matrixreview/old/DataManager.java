...
import edu.arizona.biosemantics.matrixreview.client.matrix.cells.TaxonCell;
...
import edu.arizona.biosemantics.matrixreview.old.ControlManager.ControlMode;
import edu.arizona.biosemantics.matrixreview.old.ControlManager.EditHandler;
import edu.arizona.biosemantics.matrixreview.old.event.ValueChangedEvent;
import edu.arizona.biosemantics.matrixreview.old.event.ValueChangedEventHandler;
...
public class DataManager implements EditHandler, StoreHandlers<Taxon> {
	...
	public void renameTaxon(int rowIndex, String newName) {
		Taxon taxon = store.get(rowIndex);
		taxonMatrix.modifyTaxon(taxon, newName);
